...
public class appAcademy {
	...
	public static void main (String[] args){
		...
		do {
			...
			switch (opcao) { //é uma estrutura condicional?
			case"1": 
				if(index < QTDE) {
		...
		private static void imprimir(int posicao){ // o que eu passar como parâmetro na chamada do método é o que vai ser impresso?
													//Somente o que eu passar, os restante não imprime.
